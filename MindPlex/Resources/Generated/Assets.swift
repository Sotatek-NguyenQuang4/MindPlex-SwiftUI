...
internal enum XCAsset {
  internal enum Assets {
    ...
    internal enum Welcome {
      internal static let welcomeBackground = ImageAsset(name: "welcome.background")
    }
  }
  internal enum Colors {
    internal enum MainColor {
      ...
      internal static let secondaryText = ColorAsset(name: "secondary.text")
    }
  }
}
